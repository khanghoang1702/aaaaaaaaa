    ...
    <div class="adcontainer">
        ...
        <div id="uploading" class="uploadin">
            ...
            <form action="upload" method="post" enctype="multipart/form-data">
              ...
              <% List<Items> listItems=adminpageDAO.getAllItems();%>
        <div id="managing" class="managin">
            ...
            <div id="showform" class="showform">
                ...
                <tbody>
                    ...
                    <tr>
                        <td width="100"><img src="./img/<%= item.getItemPhoto()%>" alt="Image" width="100" height="100" /></td>
                        <td width="70"> <%= item.getItemID()%></td>
                        <td width="200"><%= item.getItemName()%></td>
                        <td >$<%= item.getItemPrice()%></td>
                        <td width="70"><%= item.getItemQuantity()%></td>
                        <td width="150" >
